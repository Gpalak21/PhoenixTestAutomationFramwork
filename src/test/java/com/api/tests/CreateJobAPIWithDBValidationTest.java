...
public class CreateJobAPIWithDBValidationTest {
	...
	public void setup() {
		...
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "93502800997545", "93502800997545",
				"93502800997545", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
	...
	public void createJobAPITest() throws IOException {
		...
		int tr_customer_id = response.then().extract().body().jsonPath().getInt("data.tr_customer_id");
		...
		JobHeadDBModel jobHeadDataFromDB = JobHeadDao.getJobHeadData(tr_customer_id);
